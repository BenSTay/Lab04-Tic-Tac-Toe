...
namespace Lab04_TicTacToe.Classes
{
    public class Player
    {
        ...
        /// <summary>
        /// Gets a position on the board from user input.
        /// </summary>
        /// <param name="board">This parameter isn't used, Amanda.</param>
        /// <returns>The user's desired position.</returns>
        ...
        /// <summary>
        /// Creates a Position object using a given position number.
        /// </summary>
        /// <param name="position">The number associated with the position.</param>
        /// <returns>The position associated with the number.</returns>
        ...
        /// <summary>
        /// Prompts the user to take their turn, and
        /// </summary>
